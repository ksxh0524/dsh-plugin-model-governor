...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var CONTRIBUTION = {
			...
			descriptors: [
				descriptor("describe", "filter", { file: "src/cordis.ts", line: 362, column: 9 }),
				descriptor("configure", "patch", { file: "src/cordis.ts", line: 396, column: 9 }),
				descriptor("probe", "spec", { file: "src/cordis.ts", line: 445, column: 9 }),
				descriptor("probeStatus", "filter", { file: "src/cordis.ts", line: 514, column: 9 }),
				descriptor("cancelProbe", "target", { file: "src/cordis.ts", line: 547, column: 9 }),
			],
		};
