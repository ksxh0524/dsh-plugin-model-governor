...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var CONTRIBUTION = {
			...
			descriptors: [
				descriptor("describe", "filter", { file: "src/cordis.ts", line: 391, column: 9 }),
				descriptor("configure", "patch", { file: "src/cordis.ts", line: 425, column: 9 }),
				descriptor("probe", "spec", { file: "src/cordis.ts", line: 474, column: 9 }),
				descriptor("probeStatus", "filter", { file: "src/cordis.ts", line: 543, column: 9 }),
				descriptor("cancelProbe", "target", { file: "src/cordis.ts", line: 576, column: 9 }),
			],
		};
