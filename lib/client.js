 ...
 *  空输入点应用 = 删除该卡 RPM（{rpm:null} 回落不限）。探测调 probe({provider}) 发起、
...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var CONTRIBUTION = {
			...
			descriptors: [
				descriptor("describe", "filter", { file: "src/cordis.ts", line: 265, column: 9 }),
				descriptor("configure", "patch", { file: "src/cordis.ts", line: 296, column: 9 }),
				descriptor("probe", "spec", { file: "src/cordis.ts", line: 326, column: 9 }),
				descriptor("probeStatus", "filter", { file: "src/cordis.ts", line: 395, column: 9 }),
				descriptor("cancelProbe", "target", { file: "src/cordis.ts", line: 428, column: 9 }),
			],
		};
